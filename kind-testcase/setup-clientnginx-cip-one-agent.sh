...
#kind create cluster --name clientnginx-cip-oneagent-client --config kind-config.yaml
#kind create cluster --name clientnginx-cip-oneagent-server --config kind-config.yaml
